...
```bash
    git clone https://github.com/divyapatil711/online-banking.git
```
...
![Image 1](images/online_banking_1.png)
![Image 2](images/online_banking_2.png)
![Image 3](images/online_banking_3.png)
